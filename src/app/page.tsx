  ...
  return (
    <main>
      <nav className="container nav">
        <a className="logo" href="#top"><span className="logo-mark">P</span>PrepPath</a>
      ...
      <section id="top" className="container hero">
        ...
        <div className="preview" aria-label="PrepPath dashboard preview">
          ...
          <div className="dashboard">
            <aside className="side"><p className="side-title">PrepPath</p><div className="side-item active">Overview</div><div className="side-item">Syllabus</div><div className="side-item">Study Plan</div><div className="side-item">Revision</div><div className="side-item">Tests</div><div className="side-item">Analytics</div></aside>
